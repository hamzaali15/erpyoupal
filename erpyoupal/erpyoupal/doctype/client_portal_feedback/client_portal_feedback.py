...
class ClientPortalFeedback(Document):
	pass
...
#erpyoupal.erpyoupal.doctype.client_portal_feedback.client_portal_feedback.submit_feedback
@frappe.whitelist()
def submit_feedback(data):
	new_doc = frappe.new_doc('Client Portal Feedback')
