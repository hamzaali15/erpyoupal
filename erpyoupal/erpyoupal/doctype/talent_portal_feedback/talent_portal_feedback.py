...
class TalentPortalFeedback(Document):
	pass
...
#erpyoupal.erpyoupal.doctype.talent_portal_feedback.talent_portal_feedback.submit_feedback
@frappe.whitelist(allow_guest=True)
def submit_feedback(data):
	new_doc = frappe.new_doc('Talent Portal Feedback')
